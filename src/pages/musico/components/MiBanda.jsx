...
export default function MiBanda({ perfil, generos, navigate, calificacion = null, totalResenas = 0 }) {
  return (
    <div>
      ...
      <div style={s.statsRow}>
        ...
        <div style={s.statCard}>
          <p style={s.statValor}>{calificacion ? `${calificacion}/5` : 'Sin calificar'}</p>
          <p style={s.statLabel}>Calificación {totalResenas > 0 ? `(${totalResenas} reseñas)` : ''}</p>
        </div>
      </div>
